  ...
  return (
    <div className="page">
      <div className="notice">
        <a href="#editprofile" className="info">Personalized your article and feed. Complete your Patient Profile now.</a>
        <i className="fal fa-times"></i>
      </div>
      <div className="profile-card">
        <div className="profile-avatar">
          <img src="https://images.generated.photos/VKyZVOINQhI7XxHDhuEoiUOuitQliEKWXwhYa5PUsIk/rs:fit:512:512/Z3M6Ly9nZW5lcmF0/ZWQtcGhvdG9zL3Yz/XzA5ODIyNjMuanBn.jpg" alt="" className="profile" />
